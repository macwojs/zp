...
public interface DocumentRepository extends JpaRepository<DocumentEntity, Long> {
	@Query (value="Select * from document WHERE (doctypeid=1 or doctypeid=4 or doctypeid=5 or doctypeid=6 or doctypeid=7) and (docstatusid=1 or docstatusid=5 or docstatusid=6 or docstatusid=8 or docstatusid=9 or docstatusid=10)", nativeQuery=true)
