...
public class DBInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        createSampleMarszalekSejmu("marszaleksejmu@zp.pl", "marszalekmarszalek","Marszalek", "Sejmu", "00010102260", "HNE905783", "AAA111222", "ABC");
        createSampleMarszalekSenatu("marszaleksenatu@zp.pl", "marszalekmarszalek","Marszalek", "Senatu", "02032857461", "BWY747731", "BBB111222", "DEF");
        createSamplePosel("posel1@zp.pl", "posel1posel1", "Anna", "Nowak", "09122145291", "OHA621550", "AAA111111", "ABC");
        createSamplePosel("posel2@zp.pl", "posel2posel2", "Jan", "Kowalski", "08030261521", "SOU105394", "AAA222111", "DEF");
        createSamplePosel("posel3@zp.pl", "posel3posel3", "Bonifacy", "Wójcik", "09090474258", "RLD507081", "AAA333111", "FGH");
        createSamplePosel("posel4@zp.pl", "posel4posel4", "Maurycy", "Wiśniewski", "08122579844", "TNV813623", "AAA444111", "FGH");
        createSamplePosel("posel5@zp.pl", "posel5posel5", "Alfred", "Szymański", "01070493316", "MTE724079", "AAA555111", "ABC");
        createSampleSenator("senator1@zp.pl", "senator1senator1", "Maria", "Woźniak", "00021086865", "MWQ431891", "BBB111111", "ABC");
        createSampleSenator("senator2@zp.pl", "senator2senator2", "Luiza", "Zielińki", "01052466736", "FSB511566", "BBB222111", "DEF");
    ...
    private void createSampleMarszalekSejmu(String email, String password, String name, String surname, String pesel, String idnumber, String parlIdCard, String politicalGroup){
    ...
    private void createSampleMarszalekSenatu(String email, String password, String name, String surname, String pesel, String idnumber, String parlIdCard, String politicalGroup){
        CitizenEntity marszalek=  createBasicUser(email, password, name, surname,pesel, idnumber);
    ...
    private void createSampleSenator(String email, String password, String name, String surname, String pesel, String idnumber, String parlIdCard, String politicalGroup){
    ...
    private void createSamplePosel(String email, String password, String name, String surname, String pesel, String idnumber, String parlIdCard, String politicalGroup){
